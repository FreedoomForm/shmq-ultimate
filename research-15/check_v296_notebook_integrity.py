...
NOTEBOOKS = [
    ...
    ROOT / "research-15" / "mixllm_3level_gate_colab_v302_operator.ipynb",
]
...
for notebook_path in NOTEBOOKS:
    ...
    print(f"V302_NOTEBOOK_SOURCE_MATCH {notebook_path.name} files={len(sources)} digest={digest.hexdigest()}")
    print("V302_NOTEBOOK_HAS_WIDENED_A", "MatrixShape<16, 32>" in sources["mixllm/kernels/cutlass_extension/mq_mma_tensor_op_sm75.h"])
...
print("V302_OPERATOR_QUALITY_CELL_NOT_RUN true")
