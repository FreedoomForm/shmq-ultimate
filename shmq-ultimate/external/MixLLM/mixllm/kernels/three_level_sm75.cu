...
constexpr int kCutlassTuningAbi = 228;
...
void run_cutlass_config(
  ...
  } else if (config == CutlassConfig::kM64N64) {
...
CutlassConfig select_cutlass_config(
  ...
  for (CutlassConfig candidate : {CutlassConfig::kN128, CutlassConfig::kN64, CutlassConfig::kM64N64}) {
