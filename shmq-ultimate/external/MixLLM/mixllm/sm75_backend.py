...
def _use_fused_int4_prefill(module, x):
    """Select only complete aligned large-M shapes for packed INT4."""
    rows, width = x.shape
    return (
...
def three_level_linear_prequantized(
    ...
    metadata = None
    # Keep the expanded correctness control for every shape except the
    # independently probed, complete aligned large-M packed INT4 family.
    native_v3 = None
    use_cached_v3 = False
