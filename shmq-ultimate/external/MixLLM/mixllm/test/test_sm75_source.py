...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v310_warp_iterator_probe_contract(self):
        ...
        self.assertIn("combined[0]=low_accum[0]+16*high_accum[0]", source_compact)
        ...
        self.assertIn("sm75_int4_pair_crosswise_u16_native_store_probe_kernel", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_native_store_probe_cuda", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_native_store_probe(Tensordevice_tensor)->Tensor", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_k64_native_store_probe_kernel", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_k64_native_store_probe_cuda", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_k64_native_store_probe(Tensordevice_tensor)->Tensor", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_mn_offset_native_store_probe_kernel", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_mn_offset_native_store_probe_cuda", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_mn_offset_native_store_probe(Tensordevice_tensor)->Tensor", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_block_native_store_probe_kernel", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_block_native_store_probe_cuda", source_compact)
        self.assertIn("sm75_int4_pair_crosswise_u16_block_native_store_probe(Tensordevice_tensor)->Tensor", source_compact)
        self.assertIn("sm75_int4_pair_packed_u4_block_native_store_probe_kernel", source_compact)
        self.assertIn("sm75_int4_pair_packed_u4_block_native_store_probe_cuda", source_compact)
        self.assertIn("sm75_int4_pair_packed_u4_block_native_store_probe(Tensordevice_tensor)->Tensor", source_compact)
        self.assertIn("packed_weight_storage", source_compact)
        self.assertIn("constintcode=(k&1)?(packed>>4):(packed&15)", source_compact)
        self.assertIn("output+warp*64", source_compact)
        self.assertIn("__syncthreads()", source_compact)
        self.assertIn("add_tile_offset(U16AIterator::TensorCoord(1,0))", source_compact)
        self.assertIn("add_tile_offset(U16BIterator::TensorCoord(0,1))", source_compact)
