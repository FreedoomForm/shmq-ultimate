...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v226_legal_sm75_candidate_tuner_contract(self):
        ...
        self.assertIn("kN256=2", source_compact)
        self.assertIn("kM128N64=3", source_compact)
        self.assertIn("kM64N64=4", source_compact)
        self.assertIn("kCutlassTuningAbi=299", source_compact)
