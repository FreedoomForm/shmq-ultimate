...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v226_legal_sm75_candidate_tuner_contract(self):
        ...
        self.assertIn("kCutlassTuningAbi=283", source_compact)
    ...
    def test_v283_native_int4_shape_family_contract(self):
        source_compact = "".join(self.source.split())
        cutlass_compact = "".join(self.cutlass_testbed.split())
        self.assertIn("CorePackedInt4M128N64", cutlass_compact)
        self.assertIn("PackedInt4RunnerM128N64=Runner<CorePackedInt4M128N64,2,cutlass::uint4b_t>", cutlass_compact)
        self.assertIn("if(rows>=96)", source_compact)
        self.assertIn("PackedInt4RunnerM128N64::run", source_compact)
