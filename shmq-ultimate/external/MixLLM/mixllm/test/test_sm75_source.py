...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v287_large_m_uses_guarded_packed_correctness_control(self):
    ...
    def test_v235_direct_sm75_accumulator_mapping_contract(self):
        ...
        self.assertIn("wmma::load_matrix_sync(a_low_u4,&a_low_packed[row_tile*8][packed_offset],kPairInstructionK)", source_compact)
    ...
    def test_v238_complete_fused_warp_tile_contract(self):
        ...
        self.assertIn("constexprintkPairK=64", source_compact)
        self.assertIn("constexprintkPairInstructionK=32", source_compact)
        self.assertIn("floatpartial[kPairRowTiles][kPairNSubtiles][2]", source_compact)
        ...
        self.assertIn("wmma::load_matrix_sync(b_u4,&b_packed[warp*16+n_tile*8][packed_offset],kPairInstructionK)", source_compact)
    ...
    def test_v287_fused_int4_guarded_production_dispatch(self):
        source_compact = "".join(self.source.split())
