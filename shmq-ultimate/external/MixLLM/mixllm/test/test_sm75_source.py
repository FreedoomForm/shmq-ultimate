...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v226_legal_sm75_candidate_tuner_contract(self):
        ...
        self.assertIn("kCutlassTuningAbi=269", source_compact)
    ...
    def test_v269_all_large_m64n64_dispatch_contract(self):
        source_compact = "".join(self.source.split())
        self.assertIn("if(rows==128&&channels>=64&&width>=2048){returnCutlassConfig::kM64N64;}", source_compact)
        self.assertIn("kCutlassTuningAbi=269", source_compact)
