...
class SM75SourceContractTest(unittest.TestCase):
    ...
    def test_v275_native_packed_int4_staged_contract(self):
        ...
        self.assertIn("FragmentShuffler<ElementAMma,ElementA,MmaIterations::kRow,FragmentA::kElements,2*MmaOperandA::kElements,Operand::kA>", mixed_compact)
        self.assertIn("dst_B=convert_B(B)", mixed_compact)
        self.assertNotIn("FragmentShuffler<ElementBMma,ElementB", mixed_compact)
